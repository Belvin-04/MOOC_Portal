    ...
    <body>
        ...
        <form method="post" action="facultyHelper.php">
            <div class="form-group">
                ...
                <input class="form-control" placeholder = "Minimum Score" type="text" name="minScore" value=<?php if(isset($_GET["minScore"])){echo $_GET['minScore'];}else{echo "";} ?> >
                    ...
                    if($result->num_rows > 0){
                        ...
                        while($row = $result->fetch_assoc()){
                            ...
                            echo "<tr align='center'>";
                                ...
                                echo "<td><a href='./manageVideos.php?cid=$cId'><button class='btn btn-warning'>Manage Video</button></a> <a href='manageCourse.php?id=$cId&name=$cName&minScore=$cMinScore'><button class='btn btn-info'>Update</button></a> <a href='./facultyHelper.php?id=$cId&op=del'><button class='btn btn-danger'>Delete</button></a></td>";
                            echo "</tr>";
                        }
                        echo "</table>";
                    }
